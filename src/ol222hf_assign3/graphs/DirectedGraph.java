...
/**
 * A directed graph interface. Each node (<tt>Node</tt>) represents a unique
 * <tt>item</tt> of generic type <tt>E</tt> and two nodes representing the same
 * <tt>item</tt> can not be added to the graph. (The second attempt is silently
 * ignored.) Two items <tt>i1</tt> and <tt>i2</tt> are the same if
 * <tt>i1.equals(i2) == true</tt> and <tt>i1.hashCode() == i2.hashCode()</tt>.
 * </p>
 * Furthermore, multiple edges between two nodes is not possible (silently
 * ignored).
 * </p>
 *
 * @author jonasl
