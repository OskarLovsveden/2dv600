...
/**
 * Abstract class that supports GML generation. GML is a mark-up language for
 * graphs. The abstract method <tt>toGML</tt> is responsible for constructing a
 * string representation of the mark-up. This method is then used by the two
 * concrete methods <tt>dumpGML</tt> that saves the mark-up in a file.
 * 
 * @author jonasl
 *
 */
public abstract class GML<E> {
	...
	/**
	 * Writes an GML mark-up to a file in the directory returned by
