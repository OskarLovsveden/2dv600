...
*/
package ol222hf_assign3.graphs.test;
...
/**
 * 
 * A weakness in this case is that many tests are based on manual inspection.
 * That is, we apply algorithms on a number of well-known, predefined graphs and
 * make a manual inspection to check the correctness.
 * 
 * @author jonasl
 *
 */
public class TestDFS {
	...
	public void testPostOrder() throws Exception {
		...
		assertTrue(list.get(0) == dg.getNodeFor(i[5]) || list.get(0) == dg.getNodeFor(i[6])
				|| list.get(0) == dg.getNodeFor(i[1]));
