...
/**
 * This class defines methods that are related to breadth-first traversals. They
 * can be applied on all graphs of type DirectedGraph having nodes extending the
 * class Node.
 * <p/>
 * The bfs methods returns a list (java.util.List) of nodes in breadth-first
 * order. They also annotates each node (the public field Node.num) with a
 * breadth-first number.
 * 
 * @author jonasl
 */
