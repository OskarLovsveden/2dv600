...
public class ArraysMain {
    ...
    private static void testAddN() {
        ...
        System.out.println("Adding " + n + " to each value in " + Arrays.toString(arr) + " results in: " + Arrays.toString(addN));
        System.out.println("\n");
    }
    ...
    private static void testReplaceAll() {
        ...
        System.out.println("Replacing all " + oldN + "'s with " + newN + "'s in " + Arrays.toString(arr) + " results in: ");
